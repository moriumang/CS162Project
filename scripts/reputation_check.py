...
def check_hash_reputation(hash):
    ...
    try:
        ...
        print("Original File Name (Exif Tool) :",
              resp['analysis']['plugins']['exiftool']['results']['EXE:OriginalFileName'])
        ...
        print(
            "Complete Details were not fetched, please visit below reference through browser for more details if any.")
        print("Reference            :", reference)
    ...
    print("\n")
    ret = input("Enter 1 to return to menu: ")
    if ret.strip() == "1":
        return
    else:
        print("Wrong input, returning anyway")
        return
